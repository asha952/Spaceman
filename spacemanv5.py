...
def load_word():
    ...
    words_list = words_list[0].split(' ')  # comment this line out if you use a
    # words.txt file with each word on a new line
...
def get_guessed_word(secret_word, letters_guessed):
    ...
    Returns:
        ...
        position.  For letters in the word that the user has not yet guessed, shown
        an _ (underscore) instead.
    '''

    # TODO: Loop through the letters in secret word and build a string that
    # shows the letters that have been guessed correctly so far that are saved in
    # letters_guessed and underscores for the letters that have not been guessed
    # yet
